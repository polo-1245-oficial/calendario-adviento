...
function Door(calendar, day) {
	...
	this.adventMessage = 'Día ' + day + ' del calendario de adviento\n\n' + '"' + messages[day - 1][0] + '"';
	...
	this.content = function() { 
		...
		if( ( currentDate.getMonth() + 1 ) < 12 || currentDate.getDate() < day ) { //CAMBIAR EL 11 A 12 O SINO NO FUNCIONA XD | CAMBIAO A 1 HORA DE SALIR A PRODUCCION XD
